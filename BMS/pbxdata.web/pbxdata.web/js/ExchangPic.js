...
PhotoWall.prototype = {
    initialize: function (obj, aData, type) {
        Exchangetype = type;
        var oThis = this;
        this.oParent = $$(obj);
    ...
    create: function () {
        ...
        for (i = 0; i < this.aData.length; i++) {
            ...
            oA.innerHTML = "×";
            oImg.src = this.aData[i].split("***")[0];
            oImg.title = this.aData[i].split("***")[1];
        ...
        handle.onmousedown = function (event) {
            ...
            document.onmouseup = function () {
                ...
                if (oNear) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "/DragPic/Exchange",
                        data: { "handle": handle.firstChild.title, "oNear": oNear.firstChild.title, "type": Exchangetype },
